    ...
    <div class="container">
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="text" id="course_code" name="course_code" value="<?= isset($_POST['course_code']) ? htmlspecialchars($_POST['course_code']) : '' ?>" required>
            </div>

            <div class="form-group">
                <label for="course_name">Course Name *</label>
                <input type="text" id="course_name" name="course_name" value="<?= isset($_POST['course_name']) ? htmlspecialchars($_POST['course_name']) : '' ?>" required>
            </div>
